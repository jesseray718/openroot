...
echo -e "\n[STEP 1/5] Running openroot_unified_launch_v1.sh..."
...
echo -e "\n[STEP 2/5] Running weekly automation onepass_v3.sh..."
...
echo -e "\n[STEP 3/5] Testing dynamic pathway ledger registration..."
...
echo -e "\n[STEP 4/5] Testing dynamic pathway resolution..."
...
echo -e "\n[STEP 5/5] Running stack_gate.sh across all shell instruments..."
